...
-(id) initWithCoder:(NSCoder *)aDecoder{
    if(self = [super initWithCoder:aDecoder]){
        self.title = NSLocalizedString(@"Volley Deph",@"");
    }
    return self;
}
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section{
    return [[self.bc getStrokesForType:STROKE_TYPE_VOLLEY_DEPH] count];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    Stroke *stroke = [[self.bc getStrokesForType:STROKE_TYPE_VOLLEY_DEPH] objectAtIndex:indexPath.row];
...
- (void)segmentSelected:(id)sender {
    ...
    Stroke *stroke = [[self.bc getStrokesForType:STROKE_TYPE_VOLLEY_DEPH] objectAtIndex:row];
...
- (void) calculateScore{
    ...
    [subtotal setText:[NSString stringWithFormat:@"%i", [bc getPointsForStrokeType:STROKE_TYPE_VOLLEY_DEPH]]];
    [consistency setText:[NSString stringWithFormat:@"%i", [bc getConssistencyPointsForStrokeType:STROKE_TYPE_VOLLEY_DEPH]]];
    [total setText:[NSString stringWithFormat:@"%i", [bc getTotalPointsForStrokeType:STROKE_TYPE_VOLLEY_DEPH]]];
}
